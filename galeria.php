...
<div id="modald" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">La informacion que cambie, se vera reflejada en su sitio web, la direccion que debe ubicar acá, debe corresponder de un video de Youtube solo se debera tomar la parte que esta despues del igua,(=) ejemplo:<b>https://www.youtube.com/watch?v=1YzkQOY8njM</b> solo se debe tomar esta parte <b>1YzkQOY8njM</b> de lo contrario no funcionara.</h4>
      </div>
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
