...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="as col-md-12">
        <h1>Titulo y subtitulo de actividades ludícas</h1>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicasentrada.php" method="POST" enctype="multipart/form-data">
    <br>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicastitysubtitulo.php" method="POST" enctype="multipart/form-data">
    <br>
    <div class="form-group">
        <label for="titulo">Titulo:</label>
        <textarea class="texa form-control" id="titulo" name="titulo" required></textarea>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicasimagena.php" method="POST" enctype="multipart/form-data">
    <br>
    <div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicasdescipcion.php" method="POST" enctype="multipart/form-data">
    <br>
    <div class="form-group">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicascompromiso.php" method="POST" enctype="multipart/form-data">
    <br>
    <div class="form-group">
        <label for="titulo">Titulo:</label>
        <textarea class="texa form-control" id="titulo" name="titulo"required></textarea>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                        <div class="container">
                                <div class="row">
            <form action="gludicasimagenes.php" method="POST" enctype="multipart/form-data">
    <br>
    <div>
        <label form="archivo">Imagen:</label>
        <input type="file" name="fileToUpload" id="fileToUpload" required>
