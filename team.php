...
<html lang="en">
<head>
<title>Flex Art Corporate Category Flat Bootstrap Responsive Website Template | Team : W3layouts</title>
...
<section class="inner-page-banner">
	<div class="page-heading text-center">
		<h2>Team Page</h2>
		<span class="section_1-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i> Home</a> <span>/ Team</span></span>
	</div>
</section>
<!-- //inner page banner -->
...
<section id="myteam" class="team py-5">
	<div class="container py-md-5">
		...
		<div class="row team-row">
			...
			<div class="col-md-4 col-sm-6 mt-sm-0 mt-5 team-wrap">
				<div class="team-member text-center">
					<div class="team-img">
			...
			<div class="col-md-4 col-sm-6 mt-md-0 mt-5 team-wrap">
			...
			<!-- end team member -->
			<div class="col-md-4 col-sm-6 mt-5 team-wrap">
				<div class="team-member text-center">
					<div class="team-img">
