...
<html lang="en">
<head>
<title>Flex Art Corporate Category Flat Bootstrap Responsive Website Template | Features : W3layouts</title>
...
<section class="inner-page-banner">
	<div class="page-heading text-center">
		<h2>Features Page</h2>
		<span class="section_1-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i> Home</a> <span>/ Features</span></span>
	</div>
</section>
<!-- //inner page banner -->
...
<div class="testimonals">
	<div class="container">
		<div class="heading pb-4">
			<h3 class="heading mb-2 text-center">Clients <span> Testimonials</span> </h3>
			<p class="para mb-5 text-center">Excepteur sint occaecat non proident, sunt in culpa quis. Phasellus lacinia id.</p>
		</div>
	...
	<div class="container py-sm-3">
		<div class="d-md-flex justify-content-around pb-smm-4">
			<h4 class="agile-ser_bot text-capitalize text-white">check our newest projects</h4>
			 <div class="read">
				<a href="projects.php">Explore Now <span class="btn ml-2"><i class="fas fa-arrow-right" aria-hidden="true"></i></span></a>
			</div>
		</div>
		<hr>
