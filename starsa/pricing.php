...
<section class="inner-page-banner">
	<div class="page-heading text-center">
		<h2>Pricing Page</h2>
		<span class="section_1-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i> Home</a> <span>/ Pricing</span></span>
	</div>
</section>
<!-- //inner page banner -->
				...
				<div class="col-md-4 col-sm-6 price-main-info text-center">
					<div class="price-inner card box-shadow">
						...
						<div class="card-body">
							...
							<div class="read">
								<a href="contact.php">Buy Now <span class="btn ml-2"><i class="fas fa-arrow-right" aria-hidden="true"></i></span></a>
							</div>
						</div>
					</div>
				</div>
