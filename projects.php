...
<html lang="en">
<head>
<title>Flex Art Corporate Category Flat Bootstrap Responsive Website Template | Projects Page : W3layouts</title>
...
<section class="inner-page-banner">
	<div class="page-heading text-center">
		<h2>Projects Page</h2>
		<span class="section_1-breadcrumbs"><a href="index.php"><i class="fa fa-home home_1"></i> Home</a> <span>/ Projects page</span></span>
	</div>
</section>
<!-- //inner page banner -->
<!--start-Projects-->
<div class="Projects py-5">
	<div class="container py-sm-4">
		<div class="heading pb-4">
			<h3 class="heading mb-2 text-center"> <span>Our </span> Projects </h3>
